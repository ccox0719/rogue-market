...
export function createDefaultDCAState() {
    return {
...
export function setActiveDCAStream(state, streamId) {
...
export function setDCADailyContribution(state, amount) {
...
export function applyDCAForDay(dca, currentDayIndex, availableCash, rng = Math.random) {
...
function buildBonusEvent(streamId, totalContributed, rng) {
...
function buildNegativeEvent(streamId, totalContributed, rng) {
    const base = Math.max(0, totalContributed);
    switch (streamId) {
        case "community_fund": {
