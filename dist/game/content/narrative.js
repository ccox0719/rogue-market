export const narrativeWhales = [
    {
        ...
        signatureMoveDescription: "Boosts one sector with furious optimism for two days before collapsing it hard.",
        eraInfluence: ["Tech Euphoria", "Tech Hangover"],
        targetPlayer: "If you ride her boom, she hyper-crashes your top holding the next trading day.",
        mechanicalProfile: {
            driftMultiplier: 1.5,
            volatilitySpike: 0.4,
    ...
    },
    {
        ...
        signatureMoveDescription: "Turns attractive high-yield debt into default-risk fireworks overnight.",
        eraInfluence: ["Liquidity Crises", "Debt Cliffs"],
        targetPlayer: "If you rotate into bonds early, he forces cascading defaults on your stack.",
        mechanicalProfile: {
            driftMultiplier: 0.9,
            volatilitySpike: 0.3,
    ...
    },
    {
        ...
        signatureMoveDescription: "Stretches intraday lows far below normal bounds, triggering stops before the rebound.",
        eraInfluence: ["Volatility Storms"],
        targetPlayer: "She punishes stop-loss users by chaining forced exits before reversing the tape.",
        mechanicalProfile: {
            driftMultiplier: 1.0,
            volatilitySpike: 0.7,
    ...
    },
    {
        ...
        signatureMoveDescription: "Spikes Energy and Materials with +80% drift, then lets them collapse as scarcity fades.",
        eraInfluence: ["Oil Shocks", "Supply Chain Tangles", "Mining Frenzies"],
        targetPlayer: "Rocco tracks your highest commodity exposure and flips it overnight.",
        mechanicalProfile: {
            driftMultiplier: 1.6,
            volatilitySpike: 0.5,
            signatureMoveChance: 0.15,
    ...
    },
    {
        ...
        signatureMoveDescription: "Crashes any Healthcare name that has run past a +20% gain under regulatory pretense.",
    ...
    },
    {
        ...
        signatureMoveDescription: "Nukes Real Estate and drags Consumer sectors into a spending freeze.",
        eraInfluence: ["Housing Bubbles", "Foreclosure Waves", "Rate Spikes"],
        targetPlayer: "If your portfolio looks stable, Selene hits your safest sector to prove a point.",
        mechanicalProfile: {
            driftMultiplier: 1.2,
            volatilitySpike: 0.6,
    ...
    },
    {
        ...
        signatureMoveDescription: "Any stock above +30% becomes overvalued and tanks under his narrative.",
    ...
    },
    {
        ...
        signatureMoveDescription: "Inflates Industrials while smashes Transportation and exporting chains.",
        eraInfluence: ["Manufacturing Surges", "Tariff Wars"],
        targetPlayer: "If you hedge, he flips your weakest sector to work against you.",
        mechanicalProfile: {
            driftMultiplier: 1.4,
    ...
    },
    {
        ...
        signatureMoveDescription: "Delivers a one-day moonshot followed by a three-day consumer collapse.",
    ...
    },
    {
        ...
        signatureMoveDescription: "Spikes Utilities then cascades outages into Tech and Energy.",
    ...
    },
    {
        ...
        signatureMoveDescription: "Revises price history, erasing or muting the days you profited most.",
    ...
    },
    {
        ...
        signatureMoveDescription: "Ends the current era instantly and starts its opposite, invalidating positions.",
        eraInfluence: ["Bull vs Liquidity Crunch", "Tech Boom vs Regression"],
        targetPlayer: "Interrupts position building by flipping eras before your thesis resolves.",
        mechanicalProfile: {
            driftMultiplier: 1.0,
            volatilitySpike: 0.6,
            signatureMoveChance: 0.2,
...
export const protagonistArchetypes = [
    {
        id: "saver",
        name: "The Saver",
