const eraTemplates = [
    {
        id: "calm-market",
        name: "Calm Market",
        description: "Stability returns to the markets. Trends are gentle, volatility contracts, and events quiet down.",
        effects: {
    ...
    },
    {
        id: "tech-boom",
        name: "Tech Boom",
        description: "Software, AI, and robotics dominate. Tech companies surge while traditional sectors lag.",
        effects: {
    ...
    },
    {
        id: "energy-crisis",
        name: "Energy Crisis",
        description: "Oil and gas supply shocks ripple across the market. Energy spikes while transport bleeds.",
        effects: {
            globalTrendBias: -0.005,
    ...
    },
    {
        ...
        description: "Credit tightens and cash becomes king. Companies struggle to borrow, markets sell off sharply.",
        effects: {
    ...
    },
    {
        id: "recovery",
        name: "Recovery",
        description: "Markets rebound from recent lows. Sentiment improves and risk-taking cautiously resumes.",
        effects: {
    ...
    },
    {
        ...
        description: "Prices jump across the economy, crushing real earnings and sparking selloffs.",
        effects: {
            globalTrendBias: -0.02,
    ...
    },
    {
        id: "crypto-winter",
        name: "Crypto Winter",
        description: "Speculative assets collapse. Volatility in growth stocks trickles downward.",
        effects: {
    ...
    },
    {
        ...
        description: "Governments impose new rules. Scandals rise and compliance costs skyrocket.",
        effects: {
    ...
    },
    {
        ...
        description: "Quarterly earnings flood in. High volatility and big winners/losers.",
        effects: {
            volatilityMultiplier: 1.8,
