...
function pickRandomIndex(length, randomizer) {
    return Math.floor(randomizer() * length);
}
export function createMiniGameEvent(type, randomizer = Math.random) {
...
export function pickRandomMiniGameEvent(randomizer = Math.random) {
    const types = ["delivery", "phone", "garage"];
