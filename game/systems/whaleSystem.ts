...
import {
  createWhaleInstance,
  findWhaleProfile,
  pickRandomWhaleProfiles,
  WhaleInstance,
  WhaleProfile,
} from "../generators/whaleGen.js";
import type { Company } from "../generators/companyGen.js";
import {
  cleanupReactiveMicrocap,
  ensureReactiveMicrocapForWhale,
...
export const initializeWhales = (state: GameState, rng: RNG): void => {
